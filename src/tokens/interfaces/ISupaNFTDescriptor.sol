...
/// @title ISupaNFTDescriptor
/// @notice This contract generates the URI describing the Supa NFTs.
/// @dev Inspired by Uniswap V3 Positions NFTs & SablierV2 stream NFTs.
interface ISupaNFTDescriptor {
